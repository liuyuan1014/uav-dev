package com.uav.location.service.impl;

import com.uav.location.constant.RedisConstant;
import com.uav.location.util.LocationUtil;
import com.uav.location.mapper.UavPilotMapper;
            ...
            return results.getContent().stream()
                .map(result -> {
                    ...
                    if (pilot != null) {
                        ...
                        // TODO: completedMissions 字段需要从任务服务获取
